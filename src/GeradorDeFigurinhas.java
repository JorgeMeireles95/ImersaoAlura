...
public class GeradorDeFigurinhas {
	...
	// leitura da imagem
		...
		//leitura de URL, caso precise tratar
		// InputStream inputStream =
		// new
		...
		graphics.setFont(font.deriveFont(Font.HANGING_BASELINE, 64));
		graphics.setColor(Color.BLUE);

		// escrever uma frase na nova imagem e a centralizando
		graphics.drawString("Só filme TOP", (novaImagem.getWidth() / 3), (novaAltura - 100));
